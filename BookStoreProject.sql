...
FOREIGN KEY (loginName) REFERENCES User(loginName) ON DELETE CASCADE ON UPDATE CASCADE,
FOREIGN KEY (ISBN13) REFERENCES Book(ISBN13) ON DELETE CASCADE ON UPDATE CASCADE)
...
FOREIGN KEY (loginName) REFERENCES User(loginName) ON DELETE CASCADE ON UPDATE CASCADE,
FOREIGN KEY (userBeingRated) REFERENCES FeedbackOnBook(loginName) ON DELETE CASCADE ON UPDATE CASCADE,
FOREIGN KEY (ISBN13) REFERENCES FeedbackOnBook(ISBN13) ON DELETE CASCADE ON UPDATE CASCADE,
